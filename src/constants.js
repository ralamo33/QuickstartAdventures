...
export const PLAYTEST_CARD_TEXT = ['Create your character in 5 minutes', 'Only 10 pages of rules','Perfect for your friends that hate reading!']
export const CONTEST_CARD_TEXT = ['Gather and upgrade cards to improve your character!', 'Excited?', 'Win a Cash Prize!']
...
export const PLAYTEST_TOPIC_ARN = "arn:aws:sns:us-east-1:451835830300:AddEmail";
