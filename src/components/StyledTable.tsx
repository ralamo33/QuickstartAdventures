      ...
      <tbody>
        <OddRow>
          ...
          <td>
            <StyledList>
              <li>
                Teach it in minutes. Even to people who never played TTRPGs
                before.
              </li>
              <li>Ready to GM in half an hour or less.</li>
        ...
        <EvenRow>
          ...
          <td>
            <StyledList>
              <li>
                Thousands of unique and memorable characters to create. 4,000
                possibilities by level 4.
              </li>
              <li>
                Greater control over character progression. Decide which cards
                to unlock and upgrade.
              </li>
              <li>
                Players never read a rulebook. Everything they need to know is
        ...
        <OddRow>
          ...
          <td>
            <StyledList>
              <li>
                Give rewards to your players with confidence. Know that you're
                keeping the balance of the game.
              </li>
              <li>Balance custom monsters on the fly.</li>
              <li>
                Easily adjust monster difficulty as players weave in and out of
                sessions.
              </li>
            </StyledList>
          </td>
